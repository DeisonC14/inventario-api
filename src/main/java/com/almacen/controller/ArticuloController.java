...
public class ArticuloController {
	...
	// Actualizar médico
	@PutMapping("/{id}")
	public ResponseEntity<ApiResponse<?>> actualizar(@PathVariable Integer id, @Valid @RequestBody Articulo request,
		...
		if (actualizado != null) {
			...
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body(
					new ApiResponse<>("Articulo no encontrado para actualizar.", HttpStatus.NOT_FOUND.value(), null));
		}
	}
	...
	public ResponseEntity<ApiResponse<?>> eliminar(@PathVariable Integer id) {
		...
		if (eliminado) {
			...
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body(
					new ApiResponse<>("Articulo no encontrado para eliminar.", HttpStatus.NOT_FOUND.value(), null));
		}
